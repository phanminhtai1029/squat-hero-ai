...
<!-- 📷 [CHÈN ẢNH: Sơ đồ 33 keypoints của BlazePose - tải từ tài liệu MediaPipe chính thức] -->
...
<!-- 📷 [CHÈN ẢNH: Biểu đồ phân phối số lượng mẫu - chạy script Python để tạo biểu đồ từ dữ liệu thực] -->
...
<!-- 📷 [CHÈN ẢNH: Confusion Matrix — cần chạy script Python evaluate_model.py để tạo từ dữ liệu thực] -->
...
<!-- 📷 [CHÈN ẢNH: Screenshot webcam demo — chụp từ ứng dụng realtime_webcam.py khi chạy thật] -->
